...
const defaultFormData: AuctionFormData = {
  ...
  targetPrice: 0, // Numeric field for reverse auctions
...
function AuctionWizardReverseContent({
  language,
  onLanguageChange,
  initialData,
  ...
  const [formData, setFormData] = useState<AuctionFormData>({
    ...
    language,
    auctionSubType: "standard",
    auctionType: user?.role === "buyer" ? "reverse" : "forward",
    country: "",
    city: "",
    state: "",
  });
  ...
  const handleLaunchAuction = async () => {
    ...
    try {
      ...
      const endpoint = isEdit
        ? `/api/listing/${formData.id}?user=${encodeURIComponent(user.email)}`
      ...
      if (!result.success) {
        alert(
          result.error || `Failed to ${isEdit ? "update" : "create"} auction.`
        );
        return;
      }
      setIsLaunched(true);
      ...
      alert(
        `Failed to ${isEdit ? "update" : "create"} auction. Please try again.`
      );
    }
  };
  ...
  const generateProductDescription = async () => {
    ...
    try {
      ...
      const prompt = `Generate a compelling, professional product description for a ${
        formData.auctionType
      } auction listing.
...
- Category: ${productContext.category}${
        productContext.subCategory ? ` > ${productContext.subCategory}` : ""
      }
      ...
      <div className="">
        ...
        <div className="mb-2 mt-1 p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            {[
              {
                value: "standard",
                label: t("standardReverseAuction"),
                desc: t("standardReverseAuctionDesc"),
              },
              {
                value: "ranked",
                label: t("reverseClockAuction"),
                desc: t("reverseClockAuctionDesc"),
              },
              {
                value: "sealed",
                label: "Sealed Reverse Auction",
                desc: t("sealedBidReverseDesc"),
              },
            ].map((option) => (
              <div
                key={option.value}
        ...
        <div className="w-full mx-auto p-6">
          ...
          <div className="grid grid-cols-1 gap-6">
            <div className="p-5 card gap-5 w-full bg-gray-50">
                  ...
                  <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2 mt-2 flex items-center">
                    ...
                    >
                      ...
                      <span className="hidden absolute top-0 left-full ml-2 w-48 p-2 bg-gray-800 text-white text-xs rounded shadow-lg z-10">
                        ...
                        instructions, or any notes for suplliers.
                      </span>
                    </span>
                  </label>
        ...
        <div className="w-full mx-auto p-6 pt-2">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-4">
              ...
              {/* Left side card */}
              <div className="card p-5 space-y-5 bg-gray-50">
                <div
            ...
            <div>
              ...
              <div className="card p-5 gap-5 bg-gray-50">
                      ...
                      <div className="relative rounded-md shadow-sm">
                        ...
                        {/* <div className="absolute inset-y-0 right-0 flex items-center">
                          <select
                            id="currency"
                            name="currency"
                            className="form-select h-full py-1 pl-2 pr-7 border-transparent bg-transparent text-gray-500 dark:text-gray-400 sm:text-sm rounded-md"
                            value={formData.currency}
                            onChange={(e) =>
                              setFormData((prev) => ({
                                ...prev,
                  ...
                  <div className="pt-2 dark:border-gray-700">
                    ...
                    <div className="relative rounded-md shadow-sm">
                      ...
                      <input
                        ...
                        className="form-input pl-7"
                        placeholder="0.00"
                        value={formData.reservePrice ?? 0} // default to 0 if undefined
                        onChange={(e) =>
                          setFormData((prev) => ({
                            ...prev,
                            reservePrice:
          ...
          <div className="w-full mx-auto p-6 pt-2">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="col-span-1">
                  ...
                  <div className="flex items-center">
                    <input
                      ...
                      checked={
                        ...
                        JSON.parse(formData.requireddocuments || "[]")
                          .length === requiredDocumentOptions.length
                      }
                      onChange={(e) => {
                        ...
                        setFormData({
                          ...formData,
                          requireddocuments: JSON.stringify(updatedDocs),
                        });
                      }}
                    ...
                    <label
                      ...
                      className="ml-2 text-sm text-gray-700 dark:text-gray-300 pr-4"
                    >
                      Select All
                    </label>
                  </div>
                ...
                <div className="card p-3 space-y-5 bg-gray-50">
                  <div className="grid grid-cols-2 gap-2">
                    {requiredDocumentOptions.map((doc, index) => {
                      ...
                      const handleCheck = (checked: boolean) => {
                        let updatedDocs;
                        if (checked) {
                          updatedDocs = [...selectedDocs, { name: doc.value }];
                        } else {
                          updatedDocs = selectedDocs.filter(
                            (d) => d.name !== doc.value
                          );
                        }
                        setFormData({
                      ...
                      <div className="grid grid-cols-2 gap-4">
                        <div className="pt-2">
                          ...
                          <input
                            type="number"
                            className="form-input pl-7"
                            value={formData.evaluationCriteria.contractDuration}
                            onChange={(e) =>
                              setFormData((prev) => ({
                                ...prev,
                                evaluationCriteria: {
                        ...
                        <div className="pt-2">
                          ...
                          <input
                            type="number"
                            value={
                              formData.evaluationCriteria.commercialWeightage
                            }
                            className="form-input pl-7"
                            onChange={(e) =>
                              setFormData((prev) => ({
                                ...
                                evaluationCriteria: {
                                  ...prev.evaluationCriteria,
                                  commercialWeightage: Number(e.target.value),
                                },
                              }))
                            }
                          />
                        ...
                        <div className="pt-2">
                          ...
                          <input
                            type="text"
                            className="form-input pl-7"
                            value={formData.evaluationCriteria.paymentTerms}
                            onChange={(e) =>
                              setFormData((prev) => ({
                                ...prev,
                                evaluationCriteria: {
                        ...
                        <div>
                          ...
                          <textarea
                            className="form-input w-full"
                            value={formData.evaluationCriteria.additionalNotes}
                            onChange={(e) =>
                              setFormData((prev) => ({
                                ...prev,
                                evaluationCriteria: {
...
export default function AuctionBuilderReverse({
  initialData,
