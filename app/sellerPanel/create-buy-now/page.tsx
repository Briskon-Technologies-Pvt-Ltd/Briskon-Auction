...
const defaultFormData: BuyNowFormData = {
  // Step 1: Auction Type
      auctionType: "NULL",
  auctionSubType:"NULL",
    buy_now_price:0,
...
// Added for percentage increment (e.g., 5 for 5%)
  auctionDuration: {
    days: 0,
    hours: 0,
    minutes: 0,
...
function BuyNowContent({
  ...
  useEffect(() => {
    setFormData((prev) => ({ ...prev, buy_now_price: 0}));
  }, []); // Runs once on mount
  ...
  const handleLaunchAuction = async () => {
    ...
    try {
      ...
      const formDataToSend = {
        ...
        seller: userId,
          buy_now_price: formData.buy_now_price, // required for Buy Now
        sale_type: 2, // 2 = Buy Now only
      ...
      <div className="">
        ...
        <div className="flex items-center mt-2 ml-6">
          ...
          <h1 className="text-2xl font-bold text-gray-800 dark:text-gray-100 ml-2">
            {isEdit ? "Edit Mode" : "Create Buy Now Products"}
          </h1>
        </div>
              ...
              {/* Product Classification */}
               <div className="overflow-visible">
                          <ProductClassification
                            ...
                            subCategoryId={formData.subCategoryId || ""} // Hide if sealed
            ...
            <div>
              ...
              <div className="card p-5 gap-5 bg-gray-50">
                ...
                <div className="pb-2">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <div className="relative flex-1 rounded-md shadow-sm">
                      ...
                      <input
                        ...
                        id="buyNowPrice"
                        ref={BuyNowPrice}
                        className={`form-input pl-7 pr-4 w-full ${
                        ...
                        onChange={(e) => {
                          ...
                          if (value <= 0) {
                            setErrors((prev) => ({
                              ...prev,
                              buy_now_price:
                                "Buy now price must be greater than zero",
                            }));
                          } else {
                            setErrors((prev) => {
                              const { buy_now_price, ...rest } = prev;
                              return rest;
                            });
                          }
                        }}
                  ...
                  {errors.buy_now_price && (
                    <ErrorMessage message={errors.buy_now_price} />
                  )}
                </div>
              </div>
            </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="bg-corporate-50 dark:bg-corporate-900/30 p-4 rounded-md flex items-start animate-fade-in">
                    ...
                    <p className="text-sm text-corporate-700 dark:text-corporate-300">
                      {"Sale will run for "} {formData.auctionDuration.days}{" "}
...
export default function BuyNowBuilder({
  initialData,
