...
import AuctionWizardForwardContent from "@/app/createForward/page"; // Adjust path based on your project structure
import { ArrowLeft, LogOut } from "lucide-react";

export default function CreateForwardAuction() {
