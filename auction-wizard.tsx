              ...
              formData.auctionType === "reverse"
                ...
                : "border-gray-200 hover:border-corporate-200 dark:border-gray-700 dark:hover:border-corporate-700"
                  ...
                  <div className="space-y-4">
                    ...
                    {hasError("auctionSubType") && (
                      <ErrorMessage
                        message={getErrorMessage("auctionSubType")}
                      />
                    )}
                  </div>
                </div>
          ...
          <div className="mt-3 bg-white dark:bg-gray-800 p-4 rounded-lg border">
            ...
            {currentStep === 3 && (
              <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-x-72">
                 ...
                 {(formData.auctionType === "forward" && formData.auctionSubType !== "sealed") && (
                    <div>
                      <label
            ...
            {currentStep === 6 && formData.auctionType === "reverse" && (
              <div className="space-y-6">
                <h2 className="text-2xl font-bold text-gray-800 dark:text-gray-100">
                  {"Requirements (Products/Services/Requirements) Details"}
                </h2>
                ...
                <div className="flex-1">
                  ...
                  <input
                    ...
                    id="productName"
                    className={`form-input ${
                      hasError("productName") ? "border-destructive-500" : ""
                    }`}
                    value={formData.productName || ""}
                    onChange={(e) =>
            ...
            ${
              formData.isMultiLot
                ...
                {/* Required Documents */}
                {formData.auctionSubType !== "standard" && formData.auctionSubType !== "ranked" &&(
                  <div>
                    <label className="block text-sm font-medium text-gray-700 dark:text-gray-300">
                      {"Required Documents"}{" "}
                      <span className="text-destructive-500">*</span>
                ...
                <div className="flex gap-6">
                <div onClick={handleDivClick} className="cursor-pointer w-1/2">
                  <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
                    {"Sample images/vedios"}{" "}
